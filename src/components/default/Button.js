...
const Button = forwardRef((props, ref) => {
  ...
  return (
    <button
      ...
      className={`p-2 md:px-4 md:py-2 border-[1px] md:border-[2px] text-sm lg:text-base text-center flex justify-center items-center font-medium max-h-12 ${size} ${makeup} ${disabled ? "cursor-not-allowed opacity-80" : "cursor-pointer"
        }`}
      disabled={disabled}
    >
      {name}
